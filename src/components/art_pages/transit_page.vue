...
<div class="main_container" id="article_container_for_scroll" :style="[scroll_position,store.scroll_animation]">
    ...
    <div class="section_conatiner">
        ...
        <is_v_imgs>
        <img src="../../assets/art_pages/transit/process.png" alt="">
        </is_v_imgs>
    </div>

    <is_v_imgs>
            <img src="../../assets/art_pages/transit/poster_1.png" alt="">
    </is_v_imgs>
    ...
    <div class="discover_research_sec section_conatiner">
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/old.png" alt="">
            </is_v_imgs>
        </div>
    ...
    <div class="discover_research_sec section_conatiner">
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/re_1.png" alt="">
            </is_v_imgs>
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/re_2.png" alt="">
            </is_v_imgs>
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/re_3.png" alt="">
            </is_v_imgs>
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/re_4.png" alt="">
            </is_v_imgs>
            <a href="https://www.apta.com/wp-content/uploads/APTA-2021-Fact-Book.pdf" >By American Public Transportation Association, “APTA 2021 Fact Book”</a>
            <h3>SAFTY FEATURE
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/re_5.png" alt="">
            </is_v_imgs>
    ...
    <is_v_imgs>
            <img src="../../assets/art_pages/transit/poster_2.png" alt="">
    </is_v_imgs>
    ...
    <div class="discover_research_sec section_conatiner">
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/h_1.png" alt="">
            </is_v_imgs>
        </div>
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/h_2.png" alt="">
            </is_v_imgs>
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/h_3.png" alt="">
            </is_v_imgs>
        </div>
    ...
    <div class="discover_research_sec section_conatiner">
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/c_1.png" alt="">
            </is_v_imgs>
        </div>
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/c_2.png" alt="">
            </is_v_imgs>
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/c_3.png" alt="">
            </is_v_imgs>
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/c_4.png" alt="">
            </is_v_imgs>
        </div>
    ...
    <div class="discover_research_sec section_conatiner">
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/n_1.png" alt="">
            </is_v_imgs>
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/n_2.png" alt="">
            </is_v_imgs>
        </div>
    ...
    <is_v_imgs>
            <img src="../../assets/art_pages/transit/poster_3.png" alt="">
    </is_v_imgs>
    ...
    <div class="discover_research_sec section_conatiner">
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/p_2.png" alt="">
            </is_v_imgs>
        </div>
    ...
    <is_v_imgs>
            <img src="../../assets/art_pages/transit/poster_4.png" alt="">
    </is_v_imgs>
    ...
    <div class="discover_research_sec section_conatiner">
        ...
        <div class="section_inner_container">
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/s_1.png" alt="">
            </is_v_imgs>
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/s_2.png" alt="">
            </is_v_imgs>
            ...
            <is_v_imgs>
                <img src="../../assets/art_pages/transit/s_3.png" alt="">
            </is_v_imgs>
        </div>
    ...
    <the_footer :card_id = "store.index_array.findIndex((item)=> item.name == 'ABS_INTERNSHIP' )">
        <abs/>
    </the_footer>
...
//引入图片
import persona_1 from '../../assets/art_pages/transit/slideshow/persona_1.png'
import persona_2 from '../../assets/art_pages/transit/slideshow/persona_2.png'
