...
<div class="main_container">
    ...
    <div class = "ov_section_container bc_s">
        <div class="ov_content_container">
            ...
            <div class="breakline bc_w1"></div>
            <div class="update_tag"><h3 class="fc_s">Actively Updated</h3></div>
        </div>
    </div>  
        ...
        <div class="content_container" style="gap:80px">
            ...
            <div class="content_block_row_defult">
                <div class="content_block_texts">
                    ...
                    <h3>Let's Go analyzes users' chat content, automatically generating events based on mentioned topics, and initiates a vote. Once the vote passes, the event is added to the plan.</h3>
                </div>
                <vimeo_container class="content_block_row_iframe" :vimeolink="{radio:4,link:'https://player.vimeo.com/video/928604827?muted=1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479'}" />
            </div>
            <div class="breakline bc_w6 center"></div>
            <div class="content_block_row_defult  content_block_row_flex-reverse">
                <div class="content_block_texts">
                    <h2>AI Packing <br>
                    Recommendation</h2>
                    <h3>Recommendations are generated by AI based on the travel plan and the current packing list. Swipe down to add any items you forgot to your packing list. Click on "?" to see why you may need it.</h3>
                </div>
                <vimeo_container class="content_block_row_iframe" :vimeolink="{radio:4,link:'https://player.vimeo.com/video/928604803?muted=1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479'}" />
            </div>
            ...
            <div class="content_block_row_defult">
                <div class="content_block_texts">
                    ...
                    <h3>By scanning items in videos, Let's will automatically check off and reorder the packing list, while also adding items that appear in the video but aren't listed to the list.</h3>
                </div>
                <vimeo_container class="content_block_row_iframe" :vimeolink="{radio:4,link:'https://player.vimeo.com/video/935999720?muted=1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479'}" />
            </div>
        </div>
    </div> 
    ...
    <div class = "section_container bc_m">
        <div class="content_container">
            ...
            <div class="content_block_texts_24">
                ...
                <h3 class="fc_s">
People often feel a surge of excitement when they decide to embark on a trip. However, the process of making travel plans can be tedious and challenging, leaving many feeling drained, particularly when organizing a group trip. In today's AI-driven world, how can I create a AI powered solution/project that simplifies travel preparation for users?</h3>
            </div>
        </div>
        ...
        <div class="content_container">
            ...
            <div class="content_block_texts_24">
                <h1 class="fc_s">Challenge</h1>
                <h3 class="fc_s">
AI's powerful learning capabilities are sufficient to effortlessly create detailed and comprehensive travel plans for users. However, allowing AI to assist in deciding travel details and arrangements in a dominant manner could make users feel uneasy and offended. I need to find a balance that maximizes AI's potential while ensuring that users remain the primary decision-makers throughout the travel process.</h3>
            </div>
        </div>
    </div> 
    ...
    <div class = "section_container bc_s">
        ...
        <!-- <div class="content_container">
            <div class="content_block_texts">
                <h2></h2>
                <h3>To prevent users from feeling that AI is making decisions for them, the final authority to add, modify, or delete travel plans should be given to the users.</h3>
            </div>
        </div> -->
        ...
        <div class="content_container">
            ...
            <vimeo_container  :vimeolink="{radio:16,link:'https://player.vimeo.com/video/924794040?muted=1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479'}" />
        </div>
        ...
        <div class="content_container">
            ...
            <vimeo_container  :vimeolink="{radio:16,link:'https://player.vimeo.com/video/924794056?muted=1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479'}" />
        </div>

        <div class="content_container">
            <div class="content_block_texts">
                <h2>Usability Test Round 3</h2>
                <h3>In order to ensure the accuracy of the test results, I made further modifications to options A and B, and conducted a third round of testing. This time, both options had exactly the same functionality, with the only difference being in their display. Option A emerged as the winner in this test.</h3>
            </div>
            <vimeo_container  :vimeolink="{radio:16,link:'https://player.vimeo.com/video/924794062?muted=1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479'}" />
        </div>

        <div class="content_container">
            <div class="content_block_texts">
                <h2>Usability Test Round 4</h2>
                <h3>After the third testing phase, new issues arose. The feature aims for users to interact with an AI pop-up during chat. Using option A, users must reach to the screen's top, inconvenient since the keyboard is at the bottom. Moving the pop-up closer to the hands at the screen's bottom proved more convenient in tests, with a preference for Option B. Therefore, Option B is chosen as the final approach for its user-friendliness.</h3>
            </div>
            <vimeo_container  :vimeolink="{radio:16,link:'https://player.vimeo.com/video/928640487?muted=1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479'}" />
        </div>
    ...
    <div class = "section_container bc_m">
        <div class="content_container">
            <div class="content_block_texts_24">
                <h1 class="fc_s">Prototype 01<br>_Create a New Trip Plan</h1>
                <h3 class="fc_s">
Users can easily create a travel plan in Let's Go and start adding their favorite events. Throughout the creation process, they can also invite friends who will be traveling with them to participate in crafting a unique and collaborative travel itinerary.</h3>
        ...
        <div class="content_container">
            <div class="content_block_texts_24">
                <h1 class="fc_s">Prototype 02<br>_AI Chat Assistant</h1>
        ...
        <div class="content_container">
            <div class="content_block_texts_24">
                <h1 class="fc_s">Prototype 03<br>_Packing Assistant</h1>
                <h3 class="fc_s">The packing assistant feature provides users with a recommended packing list based on the weather forecast of their travel destination. For instance, in cold regions, Let's Go suggests bringing warm clothing.</h3>
            </div>
            <div class="content_block_buttons">
                <link_button :prototype_links = 'vp_button_3'/>
                <link_button :prototype_links = 'fp_button_3'/>
            </div>
            <vimeo_container  :vimeolink="{radio:16,link:'https://player.vimeo.com/video/928631561?muted=1&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479'}" />
            <div class="content_block_texts_24">
                <h3 class="fc_s">Additionally, users can utilize the luggage scanning function, where Let's Go identifies items in the camera view and automatically checks them off the list, aiding in efficient travel preparation.</h3>
            </div>
            <link_button :prototype_links = 'vp_button_new'/>
        ...
        <div class="content_container">
            <div class="content_block_texts_24">
                <h1 class="fc_s">Prototype 04<br>_Travel Community</h1>
...
const store = useStore()
    ...
    let vp_button_3 = {
        ...
        width:185,
        text:'Video Prototype',
        link:'https://vimeo.com/928631561?share=copy',
    }
    let vp_button_new = {
        main_color:'var(--p-color-sub)',
        sub_color:'var(--p-color-main)',
        width:185,
        text:'Video Prototype',
        link:'https://vimeo.com/928606447?share=copy',
    }
    ...
    let fp_button_3 = {
        ...
        width:185,
        text:'Figma Prototype',
        link:'https://www.figma.com/proto/Q2E9KzAWQUHdTwmmM6G0qH/MyWeb_Assets?type=design&node-id=273-25121&t=OKASE1u5BKNiYM18-1&scaling=scale-down&page-id=273%3A24270&starting-point-node-id=273%3A25121&mode=design',
    }
